...
<main role="main">
    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            <div class="col-md-10">
                <h3 class="well text-center customerProfile">Withdraw Money</h3>
               <%=request.getAttribute("message")%>
                <hr>
                <form id="withdrawForm" action="/minibank/transaction/withdraw-money" method="POST">
                    <div class="form-group row ">
                        <label for="accountNumber" class="col-lg-3 col-form-label">Account Number</label>
                        <div class="col-md-6 form-group">
                            <input value="100001" class="form-control" type="number" name="accountNumber" id="accountNumber" placeholder="Account Number ">
                        </div>
                    </div>
                    <div class="form-group row ">
                        <label for="amount" class="col-lg-3 col-form-label">Enter Amount</label>
                        <div class="col-md-6 form-group">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-8 form-group">
                            ...
                            <input type="submit" class="btn btn-outline-primary" value="Withdraw Money">
                        </div>
                    </div>
                </form>
